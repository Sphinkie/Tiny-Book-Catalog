...
# L'exemple suivant montre comment effectuer une requete a l'aide de l'API de demande Amazon EC2 sans Kit SDK pour Python (Boto3). 
# La demande effectue une demande GET et transmet les informations d'authentification a AWS a l'aide de l'en-tete Authorization.
#
# Cette requete est fait au nom d'un utilisateur IAM créé avec aws.amazon.com
# - Il faut associer la stratégie "AmazonEC2FullAccess" à cet utilisateur (ou à son groupe)
#   (attention: un délai de 24h est nécessaire)
# - il faut la clef d'accès de cet utilisateur (fournie par la console IAM de aws.amazon.com)
# - il faut la secret_key de cet utilisateur (fournie par la console IAM de aws.amazon.com)
#
# TESTS OK
# ******************************************************************
