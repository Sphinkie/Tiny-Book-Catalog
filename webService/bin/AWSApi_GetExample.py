...
L'exemple suivant montre comment effectuer une requête à l'aide de l'API de demande Amazon EC2 sans Kit SDK pour Python (Boto3). 
La demande effectue une demande GET et transmet les informations d'authentification à AWS à l'aide de l'en-tête Authorization.
'''
